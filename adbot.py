...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "684821ac272a901afef4811e")
    api_token = os.getenv("API_TOKEN", "fa5e8db82341930610b20d38fbb912628d664739c1653583697447f6651ae2d7")
